...
export default function MobileApp({
  ...
  return (
    <main className="relative flex flex-col gap-2 items-center justify-center p-2 h-screen w-full">
      ...
      {/* preview section */}
      <section className="flex flex-col gap-4 w-full h-full items-center justify-center relative touch-none overflow-hidden">
        <DndContext sensors={sensors} onDragEnd={handleDragEnd}>
          <div
            className="rounded-2xl overflow-hidden w-full h-full flex items-center justify-center relative cursor-grab active:cursor-grabbing"
            ref={containerRef}
          >
        ...
        <div className="absolute bottom-0 right-0 left-0 flex items-center gap-2 z-10 justify-between">
          ...
          >
            <div className="flex flex-col gap-2 w-full p-4">
              <PositionControl
                ...
                className="max-w-[220px] h-[220px] bg-transparent border-none"
              />
            </div>
          </VaulDrawer>
        </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  >
                    <>
                      ...
                      <div className="flex flex-col gap-6 p-4 overflow-y-auto no-scrollbar h-full pb-32">
                        {Array.from(
                          new Set(
                            RESOLUTION_PRESETS.map((preset) => preset.category)
                          )
                        ).map((category) => (
